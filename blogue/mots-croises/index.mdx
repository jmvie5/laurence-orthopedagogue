...
<div className="flex flex-col gap-4 p-4 font-mulish">
    ...
    Avec votre enfant, vous pouvez créer des mots croisés sur le site suivant (<a href="https://www.educol.net/crosswordgenerator.php" className="underline text-blue-500">https://www.educol.net/crosswordgenerator.php</a>).
