        ...
        <Layout pageTitle="">
            <div className="flex flex-col gap-8">
                <div className="flex flex-col sm:inline bg-lbf-orange lg:ml-40 p-4 rounded-lg gap-2 shadow-md shadow-gray-500 font-mulish">
                    ...
                    />
                    <p className="text-lg">
                        Laurence Bernard-Fontaine est l’orthopédagogue derrière la page Laurence bf, orthopédagogue.
                        Elle est spécialisée en difficultés d’apprentissage en français (lecture/écriture) auprès
                        d’enfants de tous âges. Comme elle a le désir d’aider le plus d’enfants possible à développer
                        leurs compétences littéraciques (lecture-écriture), elle a décidé de créer l’espace Laurence bf,
                        orthopédagogue pour rejoindre les parents, les acteurs les plus importants dans la vie des
                        enfants. Son but est de soutenir et d’aider les parents qui se questionnent sur les façons
                        d’intervenir auprès de leur enfant qui rencontre des difficultés en français.
                    </p>
                </div>
                <div className="flex flex-col items-center pt-4">
                    <div className="text-xl pb-4 font-mulish">Articles récemment publiés</div>
                    <div>
