...
const BlogPost = ({ data, children }) => {
    ...
    <Layout pageTitle={data.mdx.frontmatter.title}>
        ...
        <div className="flex flex-col md:inline md:ml-4 md:p-24">
            <GatsbyImage image={image} alt={data.mdx.frontmatter.image_alt} className="md:float-right md:ml-8 mt-4 rounded-lg max-w-sm self-center"/>
            <MDXProvider localImages={data.mdx.frontmatter.embeddedImagesLocal}>{children}</MDXProvider>
