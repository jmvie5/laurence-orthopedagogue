	...
	<div className='flex flex-col gap-8'>
		<div>
			...
			<div className='border-8 border-lbf-orange rounded-2xl p-4'>
				<StaticImage src="../images/de-isole.webp" alt="Dé de conjugaison" className="float-right bg-center bg-contain bg-no-repeat lg:mr-8 w-32 h-32"/>
		...
		<div>
			...
			<div className='border-8 border-lbf-orange rounded-2xl p-4'>
				...
				<ul className="list-disc list-inside">
				<li className="pl-4"><a href={guide} download className="underline text-blue-500">Guide de la rentrée</a>{` `}</li>
				</ul>
				<p className='pt-2'>Pour plus de détails, allez voir <Link to="/blogue/rentree" className='underline text-blue-500'>l'article complet.</Link></p>
			</div>
		</div>
	</div>
