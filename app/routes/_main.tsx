...
export default function MainLayout() {
    ...
    return (
        <div>
            ...
            <Navbar onMenuOpenChange={setIsMenuOpen} position="static" className="bg-lbf-orange" height={"6rem"}>
                <NavbarContent className="">
                    
                    <NavbarBrand className="">
                        <Link to="/" className="xxs:text-4xl text-2xl font-satisfy bg-lbf-orange">
                            <p>Laurence bf,</p>
                            <p>orthopédagogue</p>
                        </Link>
                    </NavbarBrand>
                ...
                <NavbarContent className="hidden md:flex gap-4" justify="center">
                    {menuLinks.map((item, index) => (
                        <NavbarItem key={`${item}-${index}`}>
                            <Link
                                className="w-full hover:underline underline-offset-4 text-lg font-mulish"
                                to={item.link}
                            >
                                {item.name}
                            </Link>
                ...
                <NavbarContent justify="end" className="hidden md:flex">
                    <NavbarItem>
                        <Button className="bg-lbf-bleu text-white">
                            Se connecter
                        </Button>
                    </NavbarItem>
                </NavbarContent>
                ...
                <div className="p-1 bg-gradient-to-b from-lbf-orange to-lbf-blanc absolute w-full top-0 left-0" />
                    ...
                    <Link to="#" className="w-full text-black hover:text-opacity-50 text-lg font-mulish" >
                        Se connecter
                    </Link>
