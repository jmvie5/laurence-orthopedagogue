...
export const meta: MetaFunction = () => {
    ...
    return [
      { title: "Services" },
      { name: "description", content: "Consultation en orthopédagogie et accompagnement des parents" },
    ];
};
        ...
        <div className="font-mulish">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
                ...
                <div className="flex flex-col bg-gradient-to-t md:bg-gradient-to-l from-lbf-rouge to-lbf-orange rounded-xl shadow-md shadow-gray-500 p-2 m-2 gap-2 min-h-max justify-between">
                    ...
                    />
                    <p>
                        Téléconsultations avec vous, le parent, pour vous aider à guider votre enfant vers la
                        réussite.
                    </p>
                    <ul className="list-disc ml-4 p-2">
                    ...
                    >
                        ...
                        <div className="flex flex-col md:grid md:grid-rows-2 gap-2">
                            ...
                            <label className="col-start-3 col-span-1">
                                <span>Votre enfant a-t-il déjà redoublé une année scolaire?</span>{' '}
                                <select
                                    name="redoublement"
                                    className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-lbf-orange focus:ring-1 focus:ring-lbf-orange"
                                    required
                        ...
                        <button
                            type="submit"
                            className="bg-lbf-orange hover:bg-lbf-rouge active:bg-lbf-rouge focus:outline-none focus:ring focus:ring-lbf-rouge/30 rounded-md p-2 col-start-2 col-span-1 w-32 self-center"
                        >
                            Envoyer
                        </button>
                    </form>
