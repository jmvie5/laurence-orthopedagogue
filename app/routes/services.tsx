...
import enfant_blocks from "../assets/images/enfant_blocks.webp";
import parent_enfant from "../assets/images/parent_enfant.webp";
...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Consultation en orthopédagogie et accompagnement des parents",
    },
  ];
};
...
const ServicesPage = () => {
  return (
    <div className="font-mulish">
      <h1 className="text-3xl font-bold font-mulish pb-8">Services</h1>
      <div className="flex flex-col md:flex-row gap-4 justify-center mb-12">
        <div className="flex flex-col bg-gradient-to-b md:bg-gradient-to-r from-lbf-rouge to-lbf-orange rounded-xl shadow-md shadow-gray-500 p-2 m-2 gap-2 min-h-max justify-between">
          <h1 className="text-xl font-bold self-center p-2">
            Consultation en orthopédagogie
          </h1>
          <Image
            className="rounded-xl"
            src={enfant_blocks}
            alt="Enfant qui construit une tour de blocks, source: https://pixabay.com/fr/photos/enfant-la-tour-blocs-de-construction-1864718/"
            removeWrapper
          />
          <p>
            Consultations avec votre enfant pour consolider ses apprentissages.
          </p>
        ...
        <div className="flex flex-col bg-gradient-to-t md:bg-gradient-to-l from-lbf-rouge to-lbf-orange rounded-xl shadow-md shadow-gray-500 p-2 m-2 gap-2 min-h-max justify-between">
          ...
          <Image
            className="rounded-xl"
            src={parent_enfant}
            alt="Parent qui accompagne son enfant, source: https://pixabay.com/fr/photos/gens-adulte-arri%c3%a8re-magnifique-2942847/"
            removeWrapper
          />
          <p>
            Téléconsultations avec vous, le parent, pour vous aider à guider
            votre enfant vers la réussite.
          </p>
          <ul className="list-disc ml-4 p-2">
      ...
      >
        {/* <p className="text-xl font-bold">Mes services d'orthopédagogie sont offerts ici :</p>
                <a href="https://www.apetitspasdegeant.com/" title="À petit pas de géant">
                    {' '}
                    <Image
                        src="../images/apetitpasdegeant_full.webp"
                        alt="Logo de la clinique À petit pas de géant"
                        className="bg-contain bg-right md:h-auto"
                    />
                </a>
                ...
                <div className="flex flex-col lg:flex-row gap-8 p-4 place-items-center">
                    <div className="bg-gradient-to-br from-lbf-rouge to-lbf-orange shadow-md shadow-gray-500 rounded-xl p-1 md:mb-24 max-w-sm">
                        <div className="bg-lbf-blanc rounded-xl h-full p-4">
                            <p className="pb-2">Pour prendre rendez-vous, communiquez avec la clinique au :</p>
                            <ul className="py-2">
                                <li>
                                    <a href="mailto:info@apetitspasdegeant.com" className="underline text-blue-500">
                                        info@apetitspasdegeant.com
                                    </a>
                                </li>
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2731.454604835245!2d-71.25945048473228!3d46.79535027913922!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cb896f2bb948f5f%3A0xa1f31ebdeb77edce!2s675%20Av.%20Marguerite-Bourgeoys%20%23105%2C%20Qu%C3%A9bec%20City%2C%20QC%20G1S%203V8!5e0!3m2!1sfr!2sca!4v1677860295619!5m2!1sfr!2sca"
                        allowFullScreen=""
                        loading="lazy"
                        title="Carte clinique À petits pas de géant"
        ...
        >
          <p className="text-xl font-bold p-4">Prendre rendez-vous</p>
          <p className="pb-4 select-text">
            Contactez-moi pour prendre rendez-vous en remplissant ce formulaire
            ou en m'envoyant un courriel à{" "}
          ...
          >
            ...
            <input
              type="hidden"
              name="Objet"
              value="Demande de renseignement venant de laurencebf.ca"
            />
            ...
            <div className="flex flex-col md:grid md:grid-rows-2 gap-2">
              ...
              <label className="block col-start-3 row-span-1">
                ...
                <input
                  type="number"
                  name="ageEnfant"
                  placeholder="Âge de votre enfant"
                  min={1}
                  max={18}
                  className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-lbf-orange focus:ring-1 focus:ring-lbf-orange"
                  required
              ...
              <label className="block row-start-2 col-span-1">
                ...
                <select
                  name="niveau"
                  className="mt-1 md:mt-7 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-lbf-orange focus:ring-1 focus:ring-lbf-orange"
                  required
                >
              ...
              <label className="row-start-2 col-span-1">
                ...
                >
                  ...
                  <option value="École publique ou privée">
              ...
              <label className="col-start-3 col-span-1">
                <span>
                  Votre enfant a-t-il déjà redoublé une année scolaire?
                </span>{" "}
                <select
                  name="redoublement"
                  className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-lbf-orange focus:ring-1 focus:ring-lbf-orange"
            ...
            <label className="pb-4">
              <span>Message</span>
              <textarea
                className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-lbf-orange focus:ring-1 focus:ring-lbf-orange resize-y"
                name="message"
            ...
            <Button
              type="submit"
              className="bg-lbf-bleu text-white col-start-2 col-span-1 self-center"
              size="lg"
            >
              Envoyer
            </Button>
